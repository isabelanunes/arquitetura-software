...
public class CorrecaoFosforoTest {
    ...
    public void testeQuantidadeAplicarFosforo(){
        ...
        Assert.assertEquals(123.95, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.SUPERFOSFATO_TRIPLO, 70, 1260, solo);
        Assert.assertEquals(54.41, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.MAP, 70, 1260, solo);
        Assert.assertEquals(46.48, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.DAP, 70, 1260, solo);
        Assert.assertEquals(49.58, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        ...
        Assert.assertEquals(67.60, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.FOSFATO_GAFSA, 70, 1260, solo);
        Assert.assertEquals(76.93, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.FOSFATO_DAOUI, 70, 1260, solo);
        Assert.assertEquals(69.72, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.FOSF_PATOS_MINAS, 70, 1260, solo);
        Assert.assertEquals(92.96, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.ESCORIA_THOMAS, 70, 1260, solo);
        Assert.assertEquals(120.60, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.ACIDO_FOSFORICO, 70, 1260, solo);
        Assert.assertEquals(42.90, correcaoFosforo.quantidadeAplicarElemento(), 0.1);
    ...
    public void testeCorrecaoFosforoFornece(){
        ...
        ItemCorrecaoFornece[] retornoItemCorrecaoFornece = correcaoFosforo.correcaoElemento();
        ...
        retornoItemCorrecaoFornece = correcaoFosforo.correcaoElemento();
        Assert.assertEquals(itemCorrecao1.getValor(), retornoItemCorrecaoFornece[0].getValor(),0.1);
        Assert.assertEquals(itemCorrecao1.getDescricao_item(), retornoItemCorrecaoFornece[0].getDescricao_item());
    ...
    public void testeCustoAlqueire(){
        Solo solo = new Solo(8.59, 0.15, 5.76, 1.63, 3.67, 0.0, 0.0);
        CorrecaoFosforo correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.SUPERFOSFATO_SIMPLES, 70, 1260, solo);
        Assert.assertEquals(156.17, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.SUPERFOSFATO_TRIPLO, 70, 1260, solo);
        Assert.assertEquals(68.56, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.MAP, 70, 1260, solo);
        Assert.assertEquals(58.56, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.DAP, 70, 1260, solo);
        Assert.assertEquals(62.46, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.YOORIN, 70, 1260, solo);
        Assert.assertEquals(156.17, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.FOSFATO_ARAD, 70, 1260, solo);
        Assert.assertEquals(85.18, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.FOSFATO_GAFSA, 70, 1260, solo);
        Assert.assertEquals(96.93, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.FOSFATO_DAOUI, 70, 1260, solo);
        Assert.assertEquals(87.84, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.FOSF_PATOS_MINAS, 70, 1260, solo);
        Assert.assertEquals(117.12, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.ESCORIA_THOMAS, 70, 1260, solo);
        Assert.assertEquals(151.94, correcaoFosforo.calcularCustoAlqueire(),0.1);
        
        correcaoFosforo = new CorrecaoFosforo(12, FontesFosforo.ACIDO_FOSFORICO, 70, 1260, solo);
        Assert.assertEquals(54.05, correcaoFosforo.calcularCustoAlqueire(),0.1);
